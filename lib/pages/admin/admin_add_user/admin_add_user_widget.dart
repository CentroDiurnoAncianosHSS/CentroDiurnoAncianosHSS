...
class AdminAddUserWidget extends StatefulWidget {
  const AdminAddUserWidget({Key? key}) : super(key: key);

  @override
  _AdminAddUserWidgetState createState() => _AdminAddUserWidgetState();
}
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                                ...
                                                await showDialog<bool>(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text('Aviso!'),
                                                          content: Text(
                                                              '¿Desea ralmente registrar un usuario?'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                            ...
                                            if (confirmDialogResponse) {
                                              GoRouter.of(context)
                                                  .prepareAuthEvent();
                                              if (_model.txtPassSigninController
                                                      .text !=
                                                  _model
                                                      .txtVfyPassSigninController
                                                      .text) {
