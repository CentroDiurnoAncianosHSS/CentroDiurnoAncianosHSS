                          ...
                          child: Row(
                            ...
                            children: [
                              FlutterFlowDropDown<String>(
                                controller: _model.dDFileTypeValueController ??=
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    controller: _model.txtNameArchiveController,
                                    autofocus: true,
                                    obscureText: false,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                FFButtonWidget(
                                  onPressed: () async {
                                    if (_model.txtNameArchiveController.text ==
                                        '') {
                                      await showDialog(
                                        context: context,
                                      ...
                                      if (_model.dDFileTypeValue ==
                                        ...
                                        final filesCreateData =
                                          ...
                                          nameArchive: _model
                                              .txtNameArchiveController.text,
                                          fecha: getCurrentTimestamp,
                                          urlArchiveUploadPlace:
                                              FFAppState().filePath,
                                          fileType: _model.dDFileTypeValue,
                                        );
                                  ...
                                  text: FFLocalizations.of(context).getText(
                                    'ost5et9h' /* Subir archivo Probando */,
                                  ),
                                  options: FFButtonOptions(
                                    width: 130.0,
                                    height: 40.0,
