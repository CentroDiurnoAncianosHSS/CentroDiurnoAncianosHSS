                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            title: Text('Aviso!'),
                                            content: Text(
                                                'Por favor seleccione bien el tipo de archivo ya que será almacenado como tal!  Si lo selecciono bien haga caso omiso de este mensaje!'),
                                            actions: [
                                              TextButton(
                                            ...
                                            await showDialog(
                                              ...
                                              builder: (alertDialogContext) {
                                                return AlertDialog(
                                                  title: Text('Incompleto !'),
                                                  content: Text(
                                                      'El tipo de archivo debe ser seleccionado !'),
                                                  actions: [
                                                    TextButton(
                                                      onPressed: () =>
                                                          Navigator.pop(
