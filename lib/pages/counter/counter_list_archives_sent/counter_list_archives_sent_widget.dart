...
import 'counter_list_archives_sent_model.dart';
export 'counter_list_archives_sent_model.dart';

class CounterListArchivesSentWidget extends StatefulWidget {
  const CounterListArchivesSentWidget({Key? key}) : super(key: key);

  @override
  _CounterListArchivesSentWidgetState createState() =>
      _CounterListArchivesSentWidgetState();
}

class _CounterListArchivesSentWidgetState
    extends State<CounterListArchivesSentWidget> {
  late CounterListArchivesSentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CounterListArchivesSentModel());
        ...
        child: GestureDetector(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text(
                FFLocalizations.of(context).getText(
                  'ewk9osd8' /* Lista de archivos enviados */,
                ),
                                                  ...
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      ...
                                                      highlightColor:
                                                          Colors.transparent,
                                                      onTap: () async {
                                                        await listArchivosFilesCounterRecord
                                                            .reference
                                                            .delete();
                                                      },
                                                      child: Icon(
