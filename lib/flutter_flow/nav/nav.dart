      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'CounterListArchivesArrives',
              path: 'counterListArchivesArrives',
              requireAuth: true,
              builder: (context, params) => CounterListArchivesArrivesWidget(),
            ),
            FFRoute(
              name: 'AdminListArchivesArrives',
              path: 'adminListArchivesArrives',
              requireAuth: true,
              builder: (context, params) => AdminListArchivesArrivesWidget(),
            ),
            FFRoute(
              name: 'CounterShareArchives',
              path: 'counterShareArchives',
              requireAuth: true,
              builder: (context, params) => CounterShareArchivesWidget(),
            ),
            FFRoute(
              name: 'CounterListArchivesSent',
              path: 'counterListArchivesSent',
              requireAuth: true,
              builder: (context, params) => CounterListArchivesSentWidget(),
            ),
            FFRoute(
              name: 'AdminListArchivesSent',
              path: 'adminListArchivesSent',
              requireAuth: true,
              builder: (context, params) => AdminListArchivesSentWidget(),
            )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/equipoancianos.jpg',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
